...
export class samz extends Component {
  ...
  handleSubmit = (event) =>{
    ...
    setDoc(doc(db,'userFields', user.uid), {
        ...
        excel: "uploaded from submit button"
    });
